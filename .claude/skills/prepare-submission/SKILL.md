...
3. Do not execute code until the safety policy's isolation, network, secret, resource, and cleanup controls are satisfied.
...
7. Run configuration validation and update `status.md` only after the manifest passes.
