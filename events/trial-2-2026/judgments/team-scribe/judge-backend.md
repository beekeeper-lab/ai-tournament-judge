...
model:
  ...
  completed_at: "2026-09-22T10:35:33Z"
  verified: true
  note: Model identity is harness-reported by the invoking runtime, not a self-report by this judge. No independent attestation was available inside the judging session.
