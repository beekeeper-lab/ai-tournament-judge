...
model:
  ...
  note: >-
    ...
    the model. No independent attestation beyond the harness was available.
---
...
- **B3 — the recommended installer creates a plaintext credential file.** `install.py:118-135` plus `src/config/settings.py:26,303`, against `README.md:119`, `SECURITY.md:5` and `src/config/settings.py:342`. No permission hardening on that file.
